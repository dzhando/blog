        ...
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up"
               data-aos-delay="200">{{$date->transLatedFormat('F')}} {{$date->day}}, {{ $date->year }} •
                {{ $date->format('H:i') }} • {{$post->comments->count()}} Коментария</p>
            ...
            <section class="comment-list mb-5">
                <h2 class="section-title mb-5" data-aos="fade_up">Коментарии ({{$post->comments->count()}})</h2>
                @foreach($post->comments as $comment)
                    <div class="comment-text mb-3" data-aos="fade_up">
                               <span class="username">
                        <div>
                            {{$comment->user->name}}
                        </div>
